    ...
    for group_idx in range(n_groups):
        ...
        for replicate_idx in range(replicates_per_group):
            ...
            row = {
                ...
                "legacy_label": label,
                "target_temperature_c": round(temperature, 3),
                "aging_time_minutes": round(aging, 3),
                "mixing_intensity": round(mixing, 3),
                "additive_level": round(additive, 3),
            ...
            events.append(
                {
                    ...
                    "process": {
                        ...
                        "conditions": {
                            ...
                            "final_ph": final_ph_value,
                            "mixing_description": f"synthetic_intensity_{row['mixing_intensity']}",
                            "mixing_intensity": row["mixing_intensity"],
                            "aging_time_minutes": row["aging_time_minutes"],
                            "additive_level": row["additive_level"],
                            "early_turbidity": early_turbidity_value,
